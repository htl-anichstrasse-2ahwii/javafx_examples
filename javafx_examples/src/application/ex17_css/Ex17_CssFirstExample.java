...
public class Ex17_CssFirstExample extends Application {
	...
	public void start(Stage primaryStage) {
		...
		// Man kann mehrere Stylesheets zuweisen, es geht z.B. ein allgemeines, wo
		// grundsätzlich festgelegt wird, wie Steuerelemente darstellt werden sollen
		scene.getStylesheets().add("application/application.css");
		// zusaetzlich zu speziellen Styles
		scene.getStylesheets().add("application/ex17_css/first.css");
