...
/**
 * Wenn mehrere Fragen/Eingaben mit RadioButtons auf einer Seite sind, müssen
 * diese immer zu Gruppen zusammengefasst werden Das funktioniert mit sogenannte
 * ToggleGroups Auch wie das Auslesen der Werte (also welcher Radiobutton
 * gedrückt ist) funktioniert wird hier gezeigt und wie man auf Änderungen eines
 * Buttons reagieren kann
 *
 */
public class Ex05_RadioButtons extends Application {
	...
	public void start(Stage primaryStage) {
		...
		bC.setPadding(new Insets(0, 0, 40, 0)); // (top, right, bottom, left) damit ein Abstand zwischen der ersten und
												// zweiten Gruppe ist
